    ...
    <PageContainer>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <InfoCard title="Total Reports" icon={BarChart3} iconColor="#4F46E5" index={0}>
          <p className="text-3xl font-bold text-gray-900 mt-4">1,247</p>
          <p className="text-sm text-green-600 mt-1">+12% from last month</p>
        </InfoCard>
        <InfoCard title="Active Alerts" icon={Activity} iconColor="#EF4444" index={1}>
          <p className="text-3xl font-bold text-gray-900 mt-4">23</p>
            ...
            {['Flood', 'Fire', 'Earthquake', 'Cyclone'].map((type, i) => (
              <div key={i} className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">{(4 - i) * 25}%</span>
                </div>
              </div>
            ))}
          </div>
